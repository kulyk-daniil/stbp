...
# перші п`ять простих чисел
KNOWN_PRIME = [2, 3, 5, 7, 11]

# константи, що будуть необхідні для знаходження простих чисел
...
def randinit():
    """
    Функція, що ініціалізує генератор випадкових чисел
    """
    global STATE
...
def _randrange(a, b):
    """
    Функція, що генерує випадкове число із заданими гранічними значеннями a, b
    """
    global STATE
    if STATE == None:
        randinit()
...
def binsearch(x, arr):
    """
    Функція, що виконує бінарний пошук
    """
    l, r = 0, len(arr) - 1
...
def prime_generator():
    """
    Функція, що генерує велике просте випадкове число
    """
...
def length_in_bits(x):
    """
    Функція, що повертає довжину числа в бітах
    """
...
def is_prime(x):
    """
    Функція, що перевіряє чи є задане число простим
    """
    x = int(x)
    if x < 1:
...
def is_probable_prime(x, check=12, recheck=0):
    """
    Функція, що визначає чи є простим дуже велике число
    """
    if x < 3000:
        return is_prime(x)
    if x % 2 == 0:
...
def randprime_range(a, b, c=None):
    """
    Функція, що генерує велике просте число у визначеному діапазоні
    """
...
def randprime_bits(n=256):
    """
    Функція, що генерує просте число виходячи із заданих бітів
    """
